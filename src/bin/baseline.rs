...
// Baseline 6.40 us latency to get exti response 
// pulse generator runs on med interrupt executor
// pulse detector runs on high interrupt executor
// mainloop rest of the stuff

// compare with 375 ns obtained with RTIC hardware interrupt task
