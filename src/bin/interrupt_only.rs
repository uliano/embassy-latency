...
// 6.44 us latency to get exti response 
// when pulse is generated on an another board
// pulse detector runs on high interrupt executor
// all other tasks run on med interrupt
// mainloop is wfi

// moving mainloop on med interrupt contex doesn't affect significantly the response time
// ~ 1 clock worser than externa_pulse
